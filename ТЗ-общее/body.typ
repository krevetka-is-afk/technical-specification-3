...
3. Сетевые требования: доступ к SSO edu.hse.ru, сервисам Sheets и LMS/ЕЛК через защищенные каналы.

== Требования к информационной и программной совместимости

=== Требования к информационным структурам и методам решения

Данные разделены по доменным схемам в PostgreSQL, взаимодействие между модулями осуществляется через внутренние API без прямых межсхемных JOIN. Доступ к системе осуществляется по HTTPS с использованием REST/JSON. Сервис интеграций обеспечивает импорт данных из Sheets/XLSX и экспорт в LMS/ЕЛК при необходимости.
...
4. Использование очереди сообщений, совместимых с выбранным стеком (Python, PostgreSQL).
...
#figure(
    table(
        ...
        [Техническое задание], [Утверждение требований], [Сбор исходных данных (курсы, ОП, роли), детализация функций, согласование архитектурного решения (модульный монолит на FastAPI, PostgreSQL, очередь)], [до 10.01.2026],
        ...
        [Разработка], [Минимум 1], [Импорт/парсинг Google/Yandex Sheets и XLSX, базовая фильтрация и семантический поиск, публикация каталога проектов], [Январь-Февраль 2026],
        ...
        [Тестирование и приемка], [ПМИ], [Функциональные и интеграционные испытания, нагрузочное тестирование поиска/рекомендаций, исправление замечаний, подготовка релиза], [Апрель 2026],
    )
)
