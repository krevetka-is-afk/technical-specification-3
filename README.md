...
3. Напишите основной текст документа в файлах из директории `sections`. Для удобства весь текст разбит по секциям и вынесен в отдельные файлы. В файлах уже есть структура разделов и шаблонных таблиц – редактируйте содержимое и добавляйте свои пункты.
...
* `body.typ` - сборка всех секций
* `sections` - файлы основного текста, разделённого на секции

---

## 📖 Обязательные разделы по ГОСТу

Шаблон ориентирован на ГОСТ и включает основные разделы ТЗ. В `body.typ` разделы, обязательные для оформления, начинаются с `=`. Эти разделы вынесены в отдельные файлы в `sections`:
